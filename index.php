...
<body>
  ...
  <div class="container text-center">
    <a href="https://www.nexttransfer.co.uk/booking.html" class="btnLink"> <button type="button" class="btn2 btn btn-info animated fadeInUp delay-2s"> <span class="bookOnline"> BOOK ONLINE  </span> </button>  </a>
</div>
...
<div class="container-fluid service">
  <div class="row">
    ...
    <div  class="col-md-6" id="row8"> 
        <h3 class="rowh1">ABOUT NEXT TRANSFER</h3>
        <p class="rowText">
            next Transfer is specialized in airport Transfer for the individual, group travel, business traveller, holiday Makers. With our wide ranges of fleets, you can choose the right one according to requirement. For transfer to the airport or pick up from Airport, book by using our online booking system. Our professional driver and customer service team will take care of your journey. We will monitor the flight progress in case of flight delays or cancellations. We are specialised for airport taxis and long distance taxi service from and to Heathrow, Gatwick, Stansted, Luton Airport, Southend Airport & London City airport. <br/><br/>
          <a href="https://www.nexttransfer.co.uk/booking.html" class="btnLink"> <button type="button" class="serviceBtn btn btn-info"> Book Online </button>  </a>    
        </p>
    </div>
    </div>
...
<footer class="container-fluid clear-top">
  <div class="container">    
      <ul>
        ...
        <li> <a href="index.php"> Airport Taxi </a> </li>
        <li> <a href="index.php"> Heathrow Taxi </a> </li>
        <li> <a href="index.php"> Gatwick Taxi </a> </li>
        <li> <a href="index.php"> Stansted Taxi </a> </li>
      </ul>   
  </div>
</footer>
    ...
    <!-- //jQuery first, then Popper.js, then Bootstrap JS -->  
    <!-- MiQ JS -->   
    <script type="text/javascript" src="assets/scripts/miqJs.js"> </script>
    <!-- MiQ JS -->      
